...
_lr_productions = [
  ...
  ('expr -> expr PLUS term','expr',3,'p_expr','plyexample.py',40),
  ('expr -> expr MINUS term','expr',3,'p_expr','plyexample.py',41),
  ('expr -> term','expr',1,'p_expr_term','plyexample.py',50),
  ('term -> term TIMES factor','term',3,'p_term','plyexample.py',56),
  ('term -> term DIVIDE factor','term',3,'p_term','plyexample.py',57),
  ('term -> factor','term',1,'p_term_factor','plyexample.py',66),
  ('factor -> NUM','factor',1,'p_factor','plyexample.py',72),
  ('factor -> LPAREN expr RPAREN','factor',3,'p_factor_group','plyexample.py',78),
]
