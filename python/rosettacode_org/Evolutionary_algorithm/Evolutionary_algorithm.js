    ...
    Array.prototype.reduce = function(fun /*, initialValue */) {
        ...
        if(arguments.length >= 2) {
            ...
            do {
                ...
                // if array contains no values, no inital value to return
...
Population.prototype.spawn = function(parrent) {
    this.population = [];
    for(var x=0; x < this.size; x += 1) {
...
Evolver.prototype.run = function(onCheckpoin, checkPointFrequency) {
...
function showProgress(generation, fittest) {
    console.log("Generation: " + generation + ", Best: " + fittest.individual.join("") + ", fitness:" + fittest.score + "\n");
}
