...
def main():
    ...
    for p in primes:
        ...
        print("The first %d -smooth numbers are:" % (p))
        print(nsmooth(p, 25))
        print()
    ...
    for p in primes[1:]:
        if p >= 30:
            break
        print("The 3000 t0 3202 %d -smooth numbers are:" % (p))
        print(nsmooth(p, 3002)[2999:])
        print()

    for p in [503, 509, 521]:
        print("The 30000 to 3019 %d -smooth numbers are:")
