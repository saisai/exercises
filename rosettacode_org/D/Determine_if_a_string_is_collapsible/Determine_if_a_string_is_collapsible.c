...
void printResults(char originalString[100], char finalString[100],
        int operation, char squeezeChar) {
    if(operation == SQUEEZE){
...
/*
a collapse "The better the 4-wheel drive, the further you'll be from help when ya get stuck!"
a collapse headmistressship
a collapse ""
a collapse "\"If I were two-faced, would I be wearing this one?\" --- Abraham Lincoln"
a collapse ..1111111111111111111111111111111111111111111111111111111111111117777888
a collapse "I never give 'em hell, I just tell the truth, and they think it's hell."
a collapse "                                                    --- Harry S Truman"
*/