...
console.log(evalArithmeticExp('2+3'));
console.log(evalArithmeticExp('2+3/4')); // 2.75
console.log(evalArithmeticExp('2*3-4')); // 2
console.log(evalArithmeticExp('2*(3+4)+5/6')); // 14.833333333333334
console.log(evalArithmeticExp('2 * (3 + (4 * 5 + (6 * 7) * 8) - 9) * 10')); // 7000
console.log(evalArithmeticExp('2*-3--4+-0.25')); // -2.25
