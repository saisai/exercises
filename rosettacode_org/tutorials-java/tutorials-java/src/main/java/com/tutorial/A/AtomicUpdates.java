...
public class AtomicUpdates {
    ...
    private static final Logger log = LogManager.getLogger(AtomicUpdates.class);
    ...
    private static void print(Buckets buckets) {
        while(true) {
            ...
            log.info("Current values: {} {}", getTotal(bucketValues),Arrays.toString(bucketValues));
    ...
    public static void main(String[] args) {
        ...
        log.info("Initial Array: {} {}", getTotal(values), Arrays.toString(values));
