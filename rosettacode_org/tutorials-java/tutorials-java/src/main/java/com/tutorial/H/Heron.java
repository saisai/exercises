...
public class Heron {
    ...
    public static void sort(ArrayList<int[]> list) {
        ...
        while(swapped) {
            ...
            for(int i = 1; i < list.size(); i++) {
                if(list.get(i)[4] < list.get(i-1)[4] || list.get(i)[4] < list.get(i - 1)[4] &&
    ...
    public static void main(String... args) {
        ...
        for(int i = 0; i < 10; i++) {
            System.out.println("Hello " + list.get(i)[0] + " testing " + Arrays.toString(list.get(i)));
            System.out.print("Hello ");
            Arrays.stream(list.get(i)).forEach( e -> System.out.print(e + " "));
            System.out.println();
        }
