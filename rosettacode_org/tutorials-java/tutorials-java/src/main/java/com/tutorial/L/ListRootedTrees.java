...
public class ListRootedTrees {
    ...
    private static void append(long t) {
        //System.out.println("a " + (t << 1) + " t : " + t + " - 1 | (t << 1) " + (1 | (t << 1)));
        System.out.printf("t = %d, binary = %s,(t << 1) = %d, (t << 1) = %s, (1 | (t << 1)) = %d, (1 | (t << 1)) = %s, \n",
                t, Long.toBinaryString(t),(t << 1), Long.toBinaryString((t<<1)), (1 | (t << 1)),
                Long.toBinaryString( 1 | (t<<1)));
        TREE_LIST.add(1 | (t << 1));
    }
