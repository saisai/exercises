...
public class Sort3Vars {
    ...
    public static void main(String... args) {
        ...
        for(Object obj : sortedStr) {
            System.out.printf("%s %s %n", obj, obj instanceof String);
        }
        ...
        System.out.printf("%d ", sortedBox.length);
        for(int i = 0; i < sortedBox.length; i++) {
            Box bx = (Box) sortedBox[i];
            System.out.printf("%d %n", bx.weightKg);
        }
    }
}
