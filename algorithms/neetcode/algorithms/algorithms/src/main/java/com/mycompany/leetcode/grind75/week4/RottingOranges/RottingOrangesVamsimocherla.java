package com.mycompany.leetcode.grind75.week4.RottingOranges;

public class RottingOrangesVamsimocherla {
    ...
    public static void main(String[] args) {
        ...
        RottingOrangesVamsimocherla obj = new RottingOrangesVamsimocherla();
