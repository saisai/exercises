package com.mycompany.leetcode.TopInterview150.GraphBFS.SnakesAndLadders;

import java.util.LinkedList;
import java.util.Queue;

public class SnakesAndLadders150singhabhinash {
    ...
    public static void main(String[] args) {
        ...
        SnakesAndLadders150singhabhinash obj = new SnakesAndLadders150singhabhinash();
