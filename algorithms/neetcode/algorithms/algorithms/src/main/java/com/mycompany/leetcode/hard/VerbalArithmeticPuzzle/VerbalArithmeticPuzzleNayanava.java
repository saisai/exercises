package com.mycompany.leetcode.hard.VerbalArithmeticPuzzle;

import java.util.HashSet;
import java.util.Set;

public class VerbalArithmeticPuzzleNayanava {
    String[] words;
    String result;
    ...
    public static void main(String[] args) {
        ...
        VerbalArithmeticPuzzleNayanava obj = new VerbalArithmeticPuzzleNayanava();

        System.out.println(obj.isSolvable(words, result));
    }
}
